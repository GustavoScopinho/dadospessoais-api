          ...
          <div>
            ...
            >
              ...
              <input
                ...
                placeholder="Cep"
                {...register("cep")}
              />  {errors.cep && <p className="erro-mensage">{errors.cep.message}</p>}
              <p>Logradouro:</p>
              <input
                type="text"
                id="logradouro"
              ...
              <input
                ...
                {...register("numero")}
              /> {errors.numero && <p className="erro-mensage">{errors.numero.message}</p>}
              <p>Complemento</p>
              <input
                type="text"
                id="complemento"
              ...
              /> {errors.complemento && <p className="erro-mensage">{errors.complemento.message}</p>}
              <p>Cidade</p>
              <input
                type="text"
                id="cidade"
                ...
                {...register("cidade")}
              />  {errors.cidade && <p className="erro-mensage">{errors.cidade.message}</p>}
              <p>Estado:</p>
              <input
                type="text"
                id="estado"
                ...
                {...register("estado")}
              /> {errors.estado && <p className="erro-mensage">{errors.estado.message}</p>}
              <p>País:</p>
              <input
                type="text"
                id="pais"
                placeholder="Digite seu estado"
                {...register("pais")}
              /> {errors.pais && <p className="erro-mensage">{errors.pais.message}</p>}
